...
public class UserDemo {
	public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, SecurityException,
		...
		Class<?> c = Class.forName("dang.advance.reflect.User");
		 ...
		 * System.out.println("..........."); Method[] declaredMethods =
		 * c.getDeclaredMethods(); for (Method m : declaredMethods) {
