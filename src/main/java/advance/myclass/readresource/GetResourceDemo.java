...
public class GetResourceDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(GetResourceDemo.class.getResource("/advance/myclass/readresource/GetResourceDemo.class"));
        ...
        //搜寻路径，/target/classes/advance/advance/myclass/readresource/GetResourceDemo.class 的确存在
        System.out.println(GetResourceDemo.class.getClassLoader().getResource("advance/myclass/readresource/GetResourceDemo.class"));
        System.out.println(GetResourceDemo.class.getClassLoader().getResource("advance/myclass/readresource/GetResourceDemo2.class"));
        System.out.println(GetResourceDemo.class.getClassLoader().getResource("/advance/myclass/readresource/GetResourceDemo.class"));

        //从 classpath 路径下获取所有资源的 url enumeration
        System.out.println(GetResourceDemo.class.getClassLoader().getResources("advance/myclass/readresource/GetResourceDemo.class").nextElement());
    }
